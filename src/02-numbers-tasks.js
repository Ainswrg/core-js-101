 ...
 *   5*x = 0         => 0
 */
const getLinearEquationRoot = (a, b) => (-b / a === 0 ? Math.abs(-b / a) : -b / a);
...
const getAngleBetweenVectors = (x1, y1, x2, y2) => {
  ...
  const angle = Math.atan2(x1 * y2 - y1 * x2, dot);
 ...
 */
const getParallelepipedDiagonal = (a, b, c) => Math.sqrt(a * a + b * b + c * c);
